...
// import com.cycle.rental.business.LoggedInUser;
// import com.cycle.rental.entity.User;
// import com.cycle.rental.service.UserService;
...
//         }
//          Optional<org.springframework.boot.autoconfigure.security.SecurityProperties.User> authResult = userService.authenticate(user.getName(), user.getPassword());
